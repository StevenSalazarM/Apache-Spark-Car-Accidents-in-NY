...
public class Bank2 {
	public static void main(String[] args) {
		...
		// con x8 size e coalasce 8 mi viene 32 secondi
...
//		System.out.println("Query 2:");
	...
	*/
	...
	//	System.out.println("Query 3:");
		...
		final Dataset<Row> q3_2 = q3.withColumn("avg(Lethal)",bround(q3.col("avg(Lethal)"),8));
		//q3_2.show();
		q3_2.write().format("csv").save(filePath+"/query1/");
